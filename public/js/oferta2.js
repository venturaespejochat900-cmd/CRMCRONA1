 ...
 */
 async function rellenarListadoArticuloPedido(articulo) {
    ...
    setTimeout(function() {
        ...
        // var cantidadProducto = $("#cantidadProducto\\|"+articulo.CodigoArticulo).val();
...
async function insertarPedidoenBBDD() {
