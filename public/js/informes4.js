    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            var html = '<table class="border-collapse table-auto w-full whitespace-no-wrap bg-white table-striped relative">' +
                ...
                '<th class="z-10 bg-gray-100  top-0 border-b border-gray-200 px-6 py-2 text-gray-600 font-bold  uppercase text-xs">' +
                // '#' +
                // '</th>'+
                ...
                'Clientes total' +
                '</th>';
                html +='<th class="bg-gray-100  top-0 border-b border-gray-200 px-6 py-2 text-gray-600 font-bold tracking-wider uppercase text-xs">' +
                    'clientes activos' +
                    '</th>';
                if(dato == 1){
                    html +='<th class="bg-gray-100  top-0 border-b border-gray-200 px-6 py-2 text-gray-600 font-bold tracking-wider uppercase text-xs">' +
            ...
            for (let i = 0; i < respuesta.length; i++) {                
                    ...
                    html += '<td class="border-dashed border-t border-gray-200"">' +                                
                                '<div x-data="{ show: false }">'+
                                    ...
                                    '</div>'+
                                    '<div x-show="show" class="overflow-auto left-0 top-0 bottom-0 right-0 w-full h-full fixed">'+
                                        '<div @click.away="show = false" class="relative p-3 mx-auto my-0 max-w-full" style="width: 1000px; top:70px; z-index:55;">'+
