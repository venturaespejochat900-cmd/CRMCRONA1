...
<?php
    ...
    $semanal=InfoController::semanal($IdCliente);
    $semanaAnterior=InfoController::semanaAnterior($IdCliente);
    $mes=InfoController::mes($IdCliente);
    $mesAnterior=InfoController::mesAnterior($IdCliente);
    $mesAnteriorAnio =InfoController::mesAnteriorAnio($IdCliente); 
    $anual = InfoController::anual($IdCliente);
    $anualAnterior = InfoController::anualAnterior($IdCliente);
    // $tasaAnualMedia = InfoController::tasaMediaAnual($IdCliente);
    $preescriptorMes = InfoController::preescriptorMes($IdCliente);
    $pedidos6Meses  = InfoController::pedidos6Meses($IdCliente);
    $ventasComisionista  = InfoController::ventasComisionista($IdCliente); 
    $totalVentasComisionista  = InfoController::totalVentasComisionista($IdCliente);
    $resumenAnual = InfoController::resumenAnual($IdCliente);
    $resumenAnual2 = InfoController::resumenAnual2($IdCliente);
    $resumenAnual3 = InfoController::resumenAnual3($IdCliente);
?>
...
<div class="mt-2">
    ...
    <!-- State cards -->
    <div class="grid grid-cols-2 gap-8 p-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 ">
        <!-- Value card -->
    ...
    <div class="flex flex-row grid grid-cols-1 gap-8 p-4 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1">

        <div class="flex flex-col">
            <div class="p-4 bg-white rounded-md dark:bg-darker">
                <span class="mb-2 text-xs font-medium leading-none tracking-wider text-gray-500 uppercase dark:text-primary-light">Cliente y Mes</span>                
                <?php
        ...
        <div class="flex flex-col">
            <div class="p-4 bg-white rounded-md dark:bg-darker"> 
                <span class="mb-5 text-xs font-medium leading-none tracking-wider text-gray-500 uppercase dark:text-primary-light">Pedidos Diarios Últimos 6 Meses</span>
                    <div class="overflow-x-auto bg-white rounded-lg shadow overflow-y-auto relative"
                        style="height: 150px;">
                        <table class="border-collapse table-auto w-full whitespace-no-wrap bg-white table-striped relative">
                            <thead>
