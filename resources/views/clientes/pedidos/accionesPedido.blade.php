...
<div class="flex space-x-1 justify-around">    
    ...
    <div x-data="{ show: false }">
        ...
        <button @click={show=true} type="button" class="p-1 text-blue-600 hover:bg-blue-600 hover:text-white rounded has-tooltip">
            <span class='tooltip rounded shadow-lg p-1 bg-black text-white-500 -mt-8'>Lineas Pedido</span>
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"></path></svg>
        </button>
        </div>
            ...
            <div  @click.away="show = false" class="z-50 relative p-3 mx-auto my-0 max-w-full" style="width: 1000px;">
                <div class="bg-white rounded shadow-lg border flex flex-col overflow-hidden">
                    ...
                    <div class="px-6 py-3 text-xl border-b font-bold">
                        Lineas Pedido
                        <button class="items-center space-x-2 px-3 ml-5 border border-blue-400 rounded-md bg-white text-blue-500 text leading-4 font-medium uppercase tracking-wider hover:bg-blue-200 focus:outline-none" id="{{$IdPedidoCli}}" onclick="enviarEmailPedido(this.id)"><i class="space-x-2 py-3 fas fa-paper-plane"></i></button>
                    </div>
                                ...
                                <div class="flex py-2 inline-block justify-center min-w-full sm:px-6 lg:px-8">
                                    <div class="overflow-x-auto">
                                        ...
                                        <?php
                                            ...
                                            $pedidos = ClienteController::lineasPedido($IdPedidoCli);
                                        ?>
                                        
                                        <table class="min-w-1000">
                                            <thead>
                                            <tr class="text-md font-semibold tracking-wide text-left text-gray-900 bg-gray-100 uppercase border-b border-gray-600">
                                                <th scope="col" class="px-4 py-3">Codigo Art.</th>
                                                <th scope="col" class="px-4 py-3">Descipción</th>
                                                <th scope="col" class="px-4 py-3">U.Pedidas</th>
                                                <th class="col" class="px-4 py-3">U.Servidas</th>
                                            ...
                                            @foreach($pedidos as $pedido)
                                                ...
                                                <tr class="text-gray-700 bg-blue-200">
                                                    ...
                                                    <td class="px-4 py-3 W-3/4 border">
                                                        <div class="flex items-center text-sm">
                                                    ...
                                                    <td class="px-4 py-3 border">
                                                        <div class=" text-right text-sm">
                                                            <?= round($pedido->UnidadesPedidas,2); ?>
                                                        </div>
                                                    </td> 
                                                    <td class="px-4 py-3 border">
                                                        <div class=" text-right text-sm">
                                                            <?= round($pedido->UnidadesServidas,2); ?>
                                                        </div>
                                                    </td> 
                                                    <td class="px-4 py-3 border">
                                                        <div class="text-right text-sm">
                                                    ...
                                                    <td class="px-4 py-3 border">
                                                        <div class="text-right text-sm">
                                                            ...
                                                            {{number_format(round($pedido->ImporteNeto,2), 2, ',', '.')}}€
                                                        </div>
                                                    </td>
                                                    <td class="px-4 py-3 border">
                                                        <div class="text-right text-sm">
