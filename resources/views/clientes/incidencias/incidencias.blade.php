...
@include('layouts.sidebars.sidebarIncidencias')
...
<div class="grid grid-cols-1 p-4 space-y-8 lg:gap-8 lg:space-y-0 lg:grid-cols-4 border-b">
    <div class="col-span-4 bg-white rounded-md dark:bg-darker">
        <livewire:incidencias-datatable
        searchable="ABMS_CabeceraIncidencias.VNumeroIncidencia, cliente, CAC.CodigoComisionista"   
        exportable                                
        />
    </div>        
</div>
