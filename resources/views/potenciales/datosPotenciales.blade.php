...
<div class="grid grid-cols-1 p-4 space-y-8 lg:gap-8 lg:space-y-0 lg:grid-cols-4 border-b">
    <div class="col-span-4 bg-white rounded-md dark:bg-darker">
        @php
            $randomKey = time();
        @endphp 
        <livewire:potencial-datatable :key='$randomKey' 
        searchable="Clientes.CifDni, Clientes.RazonSocial, Clientes.CodigoPostal, Clientes.Provincia, Clientes.Telefono, Clientes.EMail1"
        exportable        
        hideable="select" 
        potencial       
        />
