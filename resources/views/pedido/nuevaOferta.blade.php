                                ...
                                <div class="flex mb-4">
                                    ...
                                    <div class="w-1/4 sm:3/8 p-1">
                                        <div class="p-3 md:p-5 bg-blue-300">                                        
                                            <h2 class="mb-6 text-4xl font-bold font-heading text-white">Oferta</h2>
                                                ...
                                                <div class="grid grid-cols-1 gap-2">
                                                    <div class="col-span-8 sm:col-span-4">
                                                        ...
                                                        <div class="grid grid-cols-2">
                                                            <div class="col-6">                                                   
                                                                <label for="fecha pedido" class="block text-sm font-medium text-gray-700"> Fecha O. </label>                                                                
                                            ...
                                            <div hidden class="col-span-12 sm:col-span-7">
                                            ...
                                            <div x-data="{ show: false }">
                                                <div class="flex justify-between mt-2">
                                                    ...
                                                    <button type="button" id="eliminarPedido" name="eliminarPedido" class="block w-full py-4 bg-red-500 hover:bg-red-700 text-center text-white font-bold font-heading uppercase rounded-md transition duration-200 ml-1"><i class="fas fa-trash-alt"></i>  ELIMINAR OFERTA</button>                                                        
                                                </div>
                                                <div x-show="show" tabindex="0" class="z-10 overflow-auto left-0 top-0 bottom-0 right-0 h-full fixed">
                                                    <div  @click.away="show = false" class="z-20 relative p-3 mx-auto my-0 max-w-full" style="width: 1000px;">
                                                        <div class="bg-white rounded shadow-lg border flex flex-col overflow-hidden">
...
<script src="{{asset('js/oferta2.js')}}"></script>