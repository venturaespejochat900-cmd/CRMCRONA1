                        ...
                        <div class="box" id="tpvNoTactil">
                            <div class="box-body">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group col-md-12" id="tpvAnyadirFechaPedidoDiv">
                                        ...
                                        <div class="row">
                                            ...
                                            <!-- <div class="col-md-6">
                                                <div class="input-group" >
                                                    <h5>% P. Pago</h5>
                                                --> <input hidden id="descuentoProntoPago" name="descuentoProntoPago" class="form-control" style="width :65px;" value="0" onblur="guardarProntoPago()">
                                    ...
                                    <div class="form-group col-md-12 mt-5">
                                        <label>Observaciones Oferta:</label><br>
                                    ...
                                    <div class="col-md-12 ajusteTecladoNumericoColTPV alfondo">
                                        <div class='row m-3'>
                                                ...
                                                <button type="button" id="finalizarPedido" class="btn btn-lg btn-primary mb-1">FINALIZAR OFERTA &nbsp; &nbsp;</button>
                ...
                var html = '<table style="width:100%;" class="table table-bordered" border="0" cellspacing="0" cellpadding="0">'+
                                            ...
                                            for(let i = 0; i < response.lineas.length; i++){
                                                html += "<tr>"+
                                                    ...
                                                    "<td style='text-size:10px;'>"+response.lineas[i].DescripcionArticulo +"</td>" +
...
<script src="{{asset('js/ofer.js')}}"></script>