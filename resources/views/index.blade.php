...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{asset('media/images/sur.png')}}">
    <title>Login</title>
      ...
      <div class="content">
        ...
        <form action="{{url('/login/validarLogin')}}" id="login" method="POST">
          ...
          <div class="form-element form-stack col-6">
            ...
            <input type="password" id="form-clave" name="password" required>
          </div>
          <div class="form-element form-submit">
            <button id="boton-acceso"  name="btn" class="btn login_btn mt-4">Entrar</button>
          </div>
        </form>
      </div>
    </div>
