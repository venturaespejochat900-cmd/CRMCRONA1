...
<?php
            ...
            $prescriptor = PrescriptorController::obtenerComisionista($IdComisionista);
?>
    ...
    <div class="bg-blue-100 container">
        ...
        <input type="hidden" name="codigoComisionistaA" id="codigoComisionista" value="{{$codigoComisionista}}">        
        <input type="hidden" name="guidA" id="guidA" value="{{$IdComisionista}}">
        <input type="hidden" name="latitud" id="latitud" value="{{$prescriptor->VLatitud}}">
        <input type="hidden" name="longitud" id="longitud" value="{{$prescriptor->VLongitud}}">
        ...
        <div class="p-2">
                ...
                <div class="md:flex mb-8">
                    <div class="md:w-1/3">
                        <legend class="text-gray-900 uppercase tracking-wide text-sm">Pais</legend>
                    </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select w-full shadow-inner p-4 border-0 text-gray-900 " name="paisPrescriptor" id="paisPrescriptor">
                                ...
                                @foreach($naciones as $pais)
                                    <option value="{{$pais->CodigoNacion}}" <?php if($pais->CodigoNacion == $prescriptor->CodigoNacion) echo 'selected="selected"' ?>>
                                        {{$pais->Nacion}}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="md:flex-1 mt-2 mb:mt-0 md:px-3">
                        <div class="md:flex mb-4">                            
                            <div class="md:flex-1 md:pl-3">
                                ...
                                <input class="text-gray-900 w-full shadow-inner p-4 border-0" type="text" name="nifCif" id="nifCif" value="{{$prescriptor->CifDni}}" placeholder="">                               
                            </div>
                            <div class="md:flex-1 md:pl-3">                                                              
                            </div>
                        </div>                        
                        <div class="mb-4">
                            <label class="text-gray-700 block uppercase tracking-wide text-xs font-bold">Nombre Completo<spam class="text-red-700">*</spam></label>
                            <input class="text-gray-900 w-full shadow-inner p-4 border-0" type="text" name="nombre" id="nombre" value="{{$prescriptor->Comisionista}}" placeholder="">
                        </div>
                        <div class="md:flex mb-4">
                            <div class="md:flex-1 md:pr-3">
                                ...
                                <input class="text-gray-900 w-full shadow-inner p-4 border-0" type="text" name="direccion" id="direccion" value="{{$prescriptor->Domicilio}}" placeholder="">
                            </div>
                            <div class="md:flex-1 md:pl-3">
                                ...
                                <input class="text-gray-900 w-full shadow-inner p-4 border-0" type="text" name="poblacion" id="poblacion" value="{{$prescriptor->Municipio}}" placeholder="">                            
                            </div>
                        </div>
                        <div class="md:flex mb-4">
                            <div class="md:flex-1 md:pr-3">
                                ...
                                <select class="text-gray-900 form-select w-full shadow-inner p-4 border-0 " name="provincia" id="provincia">
                                        ...
                                        @foreach($provincias as $provincia)
                                            <option value="{{$provincia->CodigoProvincia}}"<?php if($provincia->CodigoProvincia == $prescriptor->CodigoProvincia) echo 'selected="selected"' ?>>
                                               {{$provincia->Provincia}}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="md:flex-1 md:pl-3">
                                ...
                                <input class="text-gray-900 w-full shadow-inner p-4 border-0" type="text" name="codigoPostal" id="codigoPostal" value="{{$prescriptor->CodigoPostal}}" placeholder="">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="md:flex mb-8">
                    ...
                    <div class="md:flex-1 mt-2 mb:mt-0 md:px-3">
                        <div class="mb-4">
                            ...
                            <input class="text-gray-900 w-full shadow-inner p-4 border-0" type="tel" name="telefono" id="telefono" value="{{$prescriptor->Telefono}}" placeholder="">
                        </div>
                        <div class="mb-4">
                            <label class="text-gray-700 block uppercase tracking-wide text-xs font-bold">Teléfono2</label>
                            <input class="text-gray-900 w-full shadow-inner p-4 border-0" type="tel" name="telefono2" id="telefono2" value="{{$prescriptor->Telefono2}}" placeholder="">
                        </div>                         
                        <div class="mb-4">
                            ...
                            <input class="text-gray-900 w-full shadow-inner p-4 border-0" type="email" name="eMail1"  id="eMail1" value="{{$prescriptor->EMail1}}" placeholder="">
                        </div>
                    </div>
                </div>
                <div class="md:flex mb-8">
                    ...
                    <div class="md:flex-1 mt-2 mb:mt-0 md:px-3">
                        <div class="md:flex mb-4">
                            <div class="md:flex-1 md:pr-3">
                                ...
                                <input class="text-gray-900 w-full shadow-inner p-4 border-0" type="text" name="comision" id="comision" value="{{$prescriptor->Comision}}" placeholder="">
                            </div>                            
                        </div>                       
                    </div>
                </div>
                <div class="md:flex mb-6">
                    ...
                    <div class="md:flex-1 mt-2 mb:mt-0 md:px-3">
                        <textarea class="text-gray-900 w-full shadow-inner p-4 border-0" placeholder="Observaciones" rows="3" name="observaciones" id="observaciones ">{{$prescriptor->Observaciones}}</textarea>
                    </div>
                </div>
                <div class="md:flex">
                    <div class="md:w-1/3">
                        ...
                        <div class="md:flex mb-4">
                            <div class="md:flex-1 md:pr-3">
                                ...
                                <div class="w-full flex">                                    
                                    <input class="text-gray-900 flex-1 shadow-inner p-4 border-0" type="text" name="comercialPrescriptor" id="comercialPrescriptor" value="{{$prescriptor->CodigoJefeVenta_}}" readonly>
                                </div>
                            </div>
        ...
        <div class="p-2">
            <button class="bg-blue-700 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded justify-right" name="anadirNuevoPrescriptor" id="anadirNuevoPrescriptor" onclick="actualizarPrescriptor()">Grabar datos</button>
...
function actualizarPrescriptor(){

    var datosPrescriptor = obtenerDatosPrescriptorFormulario();
...
function obtenerDatosPrescriptorFormulario(){
    

    var datosNuevoPrescriptor = {};

    //datosNuevoPrescriptor.CodigoEmpresa = session('codigoEmpresa');
    datosNuevoPrescriptor.CodigoComisionista = $('#codigoComisionistaA').val();
    ...
    datosNuevoPrescriptor.CifDni = $("#nifCif").val();
    ...
    datosNuevoPrescriptor.Observaciones = $("#observaciones").text();
    datosNuevoPrescriptor.VComisionista = $('#comercialPrescriptor').val();
    datosNuevoPrescriptor.FechaBajaLc = $('#fechaBaja').val();     
    
    datosNuevoPrescriptor.IdComisionista = $('#guidA').val();
    datosNuevoPrescriptor.VLatitud = $('#latitud').val();
    datosNuevoPrescriptor.VLongitud = $('#longitud').val();
