...
<div class="grid grid-cols-1 p-4 space-y-8 lg:gap-8 lg:space-y-0 lg:grid-cols-4 border-b">
    <div class="col-span-4 bg-white rounded-md dark:bg-darker">
        <livewire:comisionistas-datatable
        searchable="Comisionistas.CodigoComisionista, Comisionistas.Comisionista, Comisionistas.CifDni, Comisionistas.Telefono, Comisionistas.EMail1"
        exportable        
        hideable="select"   
        prescriptor           
        />
