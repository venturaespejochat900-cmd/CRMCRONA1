              ...
              >                
                ...
                <div class="mt-10 mb-4">
                  <ul class="ml-4">
                    ...
                    <li id="#minfo" onclick="$('#info').trigger('click')" class="h-10 mb-2 px-4 py-2 text-gray-600 dark:text-gray-100 flex flex-row  border-gray-300 hover:text-black   hover:bg-gray-300  hover:font-bold rounded rounded-lg">
                        <span>
                    ...
                    <li id="#meditar" onclick="$('#editar').trigger('click')" class="h-10 mb-2 px-4 py-2 text-gray-600 dark:text-gray-100 flex flex-row  border-gray-300 hover:text-black   hover:bg-gray-300  hover:font-bold rounded rounded-lg">
                        <span>              
                    ...
                    <li id="#moferta" onclick="$('#oferta').trigger('click')" class="h-10 mb-2 px-4 py-2 text-gray-600 dark:text-gray-100 flex flex-row  border-gray-300 hover:text-black   hover:bg-gray-300  hover:font-bold rounded rounded-lg">
                        <span>
                    ...
                    <li id="#mpedido" onclick="$('#pedido').trigger('click')" class="h-10 mb-2 px-4 py-2 text-gray-600 dark:text-gray-100 flex flex-row  border-gray-300 hover:text-black   hover:bg-gray-300  hover:font-bold rounded rounded-lg">
                        <span>
                    ...
                    <li id="#marticulo" onclick="$('#articulo').trigger('click')" class="h-10 mb-2 px-4 py-2 text-gray-600 dark:text-gray-100 flex flex-row  border-gray-300 hover:text-black   hover:bg-gray-300  hover:font-bold rounded rounded-lg">
                        <span>
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 2a4 4 0 00-4 4v1H5a1 1 0 00-.994.89l-1 9A1 1 0 004 18h12a1 1 0 00.994-1.11l-1-9A1 1 0 0015 7h-1V6a4 4 0 00-4-4zm2 5V6a2 2 0 10-4 0v1h4zm-6 3a1 1 0 112 0 1 1 0 01-2 0zm7-1a1 1 0 100 2 1 1 0 000-2z" clip-rule="evenodd"></path></svg>
                        </span>
                        <a>
                    ...
                    <li id="#mcobro" onclick="$('#cobro').trigger('click')" class="h-10 mb-2 px-4 py-2 text-gray-600 dark:text-gray-100 flex flex-row  border-gray-300 hover:text-black   hover:bg-gray-300  hover:font-bold rounded rounded-lg">
                        <span>
                    ...
                    <li id="#mtarifa" onclick="$('#tarifa').trigger('click')" class="hidden h-10 mb-2 px-4 py-2 text-gray-600 dark:text-gray-100 flex flex-row  border-gray-300 hover:text-black   hover:bg-gray-300  hover:font-bold rounded rounded-lg">
                        <span>
                    ...
                    <li id="#mincidencia" onclick="$('#incidencia').trigger('click')" class="h-10 mb-2 px-4 py-2 text-gray-600 dark:text-gray-100 flex flex-row  border-gray-300 hover:text-black   hover:bg-gray-300  hover:font-bold rounded rounded-lg">
                        <span>
                    ...
                    <li data-select="hacerpedido" id="hacerpedido" class="h-10 mb-2 px-4 py-2 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">                            
                        <a href="{{route('redirigirInicio',['cod'=>$CodigoCliente])}}" target="_blank">
