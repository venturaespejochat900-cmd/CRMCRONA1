...
class SearchDropdownartimodificar extends Component
{
    public $search = '';
    public $post;
    ...
    public function render()
    {
        ...
        if (strlen($this->search) >= 1) {
            ...
            $searchResults2 = DropDownArticulo::selectRaw('CodigoArticulo, DescripcionArticulo, PrecioVenta, PendienteRecibir, StockReservado, UnidadSaldo')            
            ->where(function ($quiery){
        ...
        return view('livewire.search-dropdownartimodificar', [
