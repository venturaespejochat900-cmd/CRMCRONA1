...
class EnviarOferta extends Mailable
{
    ...
    {      
        return $this->subject('Oferta Web')->view('mail.oferta');
    }

    public static function enviarEmail($pedido){
        $email_correcto = false; 
        
        $message = '<p>'.strtoupper('Oferta Web').'</p>          
        ...
        // Create a message
        $correo = (new \Swift_Message('Oferta Web'))
