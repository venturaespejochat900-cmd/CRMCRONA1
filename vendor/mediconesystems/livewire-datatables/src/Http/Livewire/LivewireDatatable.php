...
class LivewireDatatable extends Component
{
    ...
    {
        $this->perPage = config('livewire-datatables.default_per_page', 13);
    ...
    public function initialisePerPage()
    {
        ...
        if (! $this->perPage) {
            $this->perPage = $this->perPage ?? config('livewire-datatables.default_per_page', 13);
        }
    }
    ...
    public function exportPdf()
    {
        ...
        return Excel::download(new DatatableExport($results), 'tabla.pdf');
